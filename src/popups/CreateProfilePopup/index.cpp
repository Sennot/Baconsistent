...
{
  if (!Popup::init(320, 312, "GJ_square01_custom.png"_spr))
  {
    return false;
  }
  ...
  passesLabel->setPosition({12.f, 82.f});
  ...
  m_passesInput->setPosition({273.f, 82.f});
  m_passesInput->setString("20");
...
void CreateProfilePopup::onCreateProfile(CCObject *sender)
{
  ...
  profile.requiredPasses = requiredPasses;
